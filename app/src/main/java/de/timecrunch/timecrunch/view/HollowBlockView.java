...
public class HollowBlockView extends View {
    ...
    public HollowBlockView(Context context, String colorString, String title) {
        super(context);
    ...
    public HollowBlockView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public HollowBlockView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    public HollowBlockView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
