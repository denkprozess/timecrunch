...
import de.timecrunch.timecrunch.viewListener.BlockOnEditModeTouchListener;
import de.timecrunch.timecrunch.viewListener.BlockOnLongClickListener;
...
public class TimeBlockView extends View {
    ...
    public TimeBlockView(Context context, String blockId, ArrayList<TimeBlockTaskModel> tasks, String colorString,
    ...
    public TimeBlockView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public TimeBlockView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    public TimeBlockView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
