...
import de.timecrunch.timecrunch.view.HollowBlockView;
import de.timecrunch.timecrunch.viewListener.TemplateDragEventListener;
...
public class TemplatesFragment extends Fragment {
    ...
    /*
        Creates a new HollowBlock for a category in the sidebar
     */
    private void createHollowBlock(Category c) {
        ...
        final HollowBlockView hollowBlock = new HollowBlockView(this.getContext(), colorString, c.getName());
        hollowBlock.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                ViewGroup.LayoutParams.WRAP_CONTENT));

        hollowBlock.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                ...
                View.DragShadowBuilder myShadow = new View.DragShadowBuilder(hollowBlock);
        ...
        templateContainer.addView(hollowBlock);
    }
}
